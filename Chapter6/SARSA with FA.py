...
def sarsa(env, estimator, n_episode, gamma, epsilon, epsilon_decay):
    ...
    for episode in range(n_episode):
        ...
        while not is_done_1 and not is_done_2:
            ...
            td_target = reward + gamma * q_value_next[next_action]
...
epsilon = 0.1
epsilon_decay = 0.99
sarsa(env, estimator, n_episode, gamma, epsilon, epsilon_decay)
